...
# in both their production and test forms, then runs the bridge tests that pin
# the adapter's main-thread refusal, its window-focus handling, and the
# per-window scoping a daemon's export rests on.
