...
fn template(path: &str) -> Option<&'static str> {
    match path {
        ...
        "alert_dialog.rs" => Some(include_str!("ui/alert_dialog.rs")),
        ...
        "chart.rs" => Some(include_str!("ui/chart.rs")),
        "collapsible.rs" => Some(include_str!("ui/collapsible.rs")),
        "combobox.rs" => Some(include_str!("ui/combobox.rs")),
        "command.rs" => Some(include_str!("ui/command.rs")),
        "context_menu.rs" => Some(include_str!("ui/context_menu.rs")),
        "data_table.rs" => Some(include_str!("ui/data_table.rs")),
        "date_picker.rs" => Some(include_str!("ui/date_picker.rs")),
        "direction.rs" => Some(include_str!("ui/direction.rs")),
        "dialog.rs" => Some(include_str!("ui/dialog.rs")),
        "drawer.rs" => Some(include_str!("ui/drawer.rs")),
        "dropdown_menu.rs" => Some(include_str!("ui/dropdown_menu.rs")),
        "focus_control.rs" => Some(include_str!("ui/focus_control.rs")),
        "hover_card.rs" => Some(include_str!("ui/hover_card.rs")),
        ...
        "menu.rs" => Some(include_str!("ui/menu.rs")),
        "menubar.rs" => Some(include_str!("ui/menubar.rs")),
        "message.rs" => Some(include_str!("ui/message.rs")),
        "message_scroller.rs" => Some(include_str!("ui/message_scroller.rs")),
        "modal.rs" => Some(include_str!("ui/modal.rs")),
        "native_select.rs" => Some(include_str!("ui/native_select.rs")),
        "navigation_menu.rs" => Some(include_str!("ui/navigation_menu.rs")),
        "pagination.rs" => Some(include_str!("ui/pagination.rs")),
        "popover.rs" => Some(include_str!("ui/popover.rs")),
        ...
        "select.rs" => Some(include_str!("ui/select.rs")),
        "separator.rs" => Some(include_str!("ui/separator.rs")),
        "sheet.rs" => Some(include_str!("ui/sheet.rs")),
        "sidebar.rs" => Some(include_str!("ui/sidebar.rs")),
        ...
        "sonner.rs" => Some(include_str!("ui/sonner.rs")),
        ...
        "toast.rs" => Some(include_str!("ui/toast.rs")),
        ...
        "tooltip.rs" => Some(include_str!("ui/tooltip.rs")),
        _ => None,
    }
}
