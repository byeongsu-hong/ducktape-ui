...
| Window, focus, close, drag/drop and IME subscriptions | Native runtime | No complete guest subscription contract; generic event listeners carry keyboard+mouse only | Real native events reach both backends without duplicate widget delivery |
