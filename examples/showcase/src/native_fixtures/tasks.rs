#[cfg(test)]
mod font_events {
    ui_lang::include_app!("tests/cases/ui/font_events.ice");
}

#[cfg(test)]
mod task_groups {
    ui_lang::include_app!("tests/cases/ui/task_groups.ice");
...
#[cfg(test)]
mod task_cancel {
    ui_lang::include_app!("tests/cases/ui/task_cancel.ice");
...
mod request_lane_lifecycle {
    ui_lang::include_app!("tests/cases/ui/request_lane_lifecycle.ice");
...
mod stream_lane_lifecycle {
    ui_lang::include_app!("tests/cases/ui/stream_lane_lifecycle.ice");
...
mod route_snapshot_lifecycle {
    ui_lang::include_app!("tests/cases/ui/route_snapshot_lifecycle.ice");
...
#[cfg(test)]
mod task_stream {
    ui_lang::include_app!("tests/cases/ui/task_stream.ice");
...
#[cfg(test)]
mod task_sip {
    ui_lang::include_app!("tests/cases/ui/task_sip.ice");
...
#[cfg(test)]
mod task_flow {
    ui_lang::include_app!("tests/cases/ui/task_flow.ice");
...
#[cfg(test)]
mod task_map {
    ui_lang::include_app!("tests/cases/ui/task_map.ice");
...
mod theme_factory {
    ...
    ui_lang::include_app!("tests/cases/ui/theme_factory.ice");
...
#[cfg(test)]
mod alternate_theme {
    ui_lang::include_app!("tests/cases/ui/alternate_theme.ice");
...
#[cfg(test)]
mod native_overlay {
    ui_lang::include_app!("tests/cases/ui/native_overlay.ice");
...
#[cfg(test)]
mod timer {
    ui_lang::include_app!("tests/cases/ui/timer.ice");
...
#[cfg(test)]
mod animation {
    ui_lang::include_app!("tests/cases/ui/animation.ice");
...
mod image_allocation {
    ui_lang::include_app!("tests/cases/ui/image_allocation.ice");
...
#[cfg(test)]
mod debug_timing {
    ui_lang::include_app!("tests/cases/ui/debug_timing.ice");
...
#[cfg(test)]
mod canvas_events {
    ui_lang::include_app!("tests/cases/ui/canvas_events.ice");
...
#[cfg(test)]
mod daemon {
    ui_lang::include_app!("tests/cases/ui/daemon.ice");
