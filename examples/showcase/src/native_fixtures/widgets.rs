...
mod dynamic_widget_operations {
    ui_lang::include_app!("tests/cases/ui/dynamic_widget_operations.ice");
...
mod scoped_widget_operations {
    ui_lang::include_app!("tests/cases/ui/scoped_widget_operations.ice");
...
mod widget_selectors {
    ui_lang::include_app!("tests/cases/ui/widget_selectors.ice");
...
#[cfg(test)]
mod component_state {
    ui_lang::include_app!("tests/cases/ui/component_state.ice");
...
mod component_lifecycle {
    ui_lang::include_app!("tests/cases/ui/component_lifecycle.ice");
...
mod test_mount_features {
    ui_lang::include_app!("tests/cases/ui/test_mount_features.ice");
}

#[cfg(test)]
mod virtual_rows {
    ui_lang::include_app!("tests/cases/ui/virtual_rows.ice");
}
...
mod component_output {
    ...
    ui_lang::include_app!("tests/cases/ui/component_output.ice");
...
mod handler_component_retention {
    ui_lang::include_app!("tests/cases/ui/handler_component_retention.ice");
