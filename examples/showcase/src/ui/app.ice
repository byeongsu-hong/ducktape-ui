          ...
          col #page @page
            ...
            row
              with
                ...
                gap=12.0
                align=center
              button "Open dialog" h=38.0 @primary_action -> open_dialog
              if !toast_visible
                button "Show toast" h=38.0 @secondary_action -> show_toast
              space w=fill h=1.0
              if toast_visible
                Toast title="Migration active" description="This screen is generated by ui-lang."
                  button "×" -> dismiss_toast
                    with
                      label="Dismiss toast"
                      w=32.0
                      h=32.0
        ...
        Dialog.Actions
          row
            with
              ...
              align=end
            space w=fill h=1.0
            button "Cancel" h=38.0 @secondary_action -> close_dialog
            button "Continue" h=38.0 @primary_action -> close_dialog
