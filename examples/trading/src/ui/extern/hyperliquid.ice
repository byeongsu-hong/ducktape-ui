extern crate::hyperliquid
  Tape()
  HlError(message:str)
  SymbolRow(name:str, price:f64, change_pct:f64, volume:f64, funding_pct:f64, leverage:f64, open_interest:f64, oracle:f64, prev:f64)
  ...
  Account(value:f64, pnl:f64, margin_used:f64, withdrawable:f64, notional:f64, maintenance:f64, health:f64, positions:[Position])
  Fill(coin:str, ts:i64, price:f64, size:f64, buy:bool, closed_pnl:f64, action:str, fee:f64, heat:i64)
