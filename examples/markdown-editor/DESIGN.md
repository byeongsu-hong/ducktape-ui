...
| macOS chrome | The title bar is hidden and transparent with a full-size content view; the sidebar reserves a 28 px strip under the native traffic lights, and that strip plus the sheet header drag the window | `seamless_titlebar_reserves_a_drag_strip`, `decorated_window_has_no_drag_strip` |
