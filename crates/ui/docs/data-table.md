...
Ducktape treats a data table as a composition recipe because every data set has different sorting, filtering, selection, and server-side pagination rules.
