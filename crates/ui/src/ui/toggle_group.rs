...
mod tests {
    ...
    #[test]
    fn default_gap_and_zero_gap_outline_joins_match_ducktape() {
        ...
        let state = ToggleGroupState::<()>::Single(None);
        let invalid: ToggleGroup<'_, (), ()> = toggle_group(
            [],
            &state,
            ToggleGroupOrientation::Horizontal,
            |_| (),
