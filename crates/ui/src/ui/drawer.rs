...
mod tests {
    ...
    #[test]
    fn invalid_optional_max_size_keeps_the_side_specific_default() {
        let focus = FocusScope::new(widget::Id::unique(), widget::Id::unique());
        let component = drawer(
            Space::new(),
            &DrawerState::new(false),
            Space::new(),
            &focus,
            |_| (),
            &LIGHT,
        ...
        assert_eq!(component.max_size, None);
    }
