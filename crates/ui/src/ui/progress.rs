...
fn tone(theme: &Theme, variant: ProgressVariant) -> iced::Color {
    match variant {
        ...
        ProgressVariant::Success => mix(theme.palette.success, theme.palette.foreground, 0.28),
        ProgressVariant::Warning => mix(theme.palette.warning, theme.palette.foreground, 0.40),
