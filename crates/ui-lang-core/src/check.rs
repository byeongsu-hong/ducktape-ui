...
pub(crate) use facts::{
    ...
    CheckedMarkdown, CheckedMatchArm, CheckedMatchPattern, CheckedMedia, CheckedPaneAxis,
    ...
    CheckedPaneView, CheckedPathRoot, CheckedPickList, CheckedProjection, CheckedProjectionKind,
