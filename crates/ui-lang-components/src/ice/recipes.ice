...
recipe primary_action for button
  @text-12.5px font-semibold px-16px py-11px bg-primary text-primary_fg rounded-9px hover:bg-primary_hover pressed:bg-primary/80 disabled:bg-disabled disabled:text-disabled_fg focus-visible:border-primary_fg
...
recipe danger_action for button
  @text-12.5px font-semibold px-16px py-11px bg-danger text-danger_fg rounded-9px hover:bg-danger/90 pressed:bg-danger/80 disabled:opacity-50 focus-visible:border-danger_fg
